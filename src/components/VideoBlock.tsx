              ...
              <div className="flex flex-col gap-4">
                <div className="bg-accent/5 border-2 border-dashed border-accent/20 rounded-md p-8 text-center cursor-pointer hover:bg-accent/10 transition-colors">
                  ...
                  <label htmlFor="video-upload" className="w-full h-full flex flex-col items-center justify-center cursor-pointer">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">MP4, WEBM, MKV, OGG and other formats supported</p>
                  </label>
                </div>
              </div>
            </TabsContent>
            <TabsContent value="embed" className="py-4">
              <div className="flex flex-col gap-4">
                <div className="bg-accent/5 border border-accent/10 rounded-md p-6">
                  <h3 className="text-base font-medium mb-4 text-foreground">Paste a link to a video</h3>
